...
const forcast = new Forcast();//calling the constructor
...
cityForm.addEventListener('submit', (e)=>{
    ...
    //add previous value into local storage to retrieve previous input
    localStorage.setItem('city', city);
});

//this will display previous inputs saved in the local storage automatically when opened in the browser
